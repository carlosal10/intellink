  ...
  return (
    <div className="trade-link-container">
      ...
      <section className="trade-link-hero">
        ...
        <p>
          Doing business across borders can be complex—even overwhelming—without
          deep local knowledge. TradeLink simplifies the process so you can
      ...
      <section className="trade-link-offer">
        ...
        <ul>
          ...
          <li>
            <strong>Market Entry & Sales Channel Strategy:</strong> Identify the
            best entry routes and promotional opportunities.
          </li>
          <li>
      ...
      <section className="trade-link-cases">
        ...
        <ul>
          ...
          <li>
            Tokyo-based food company seeking verified Kenyan ingredient
            suppliers.
          </li>
          <li>
